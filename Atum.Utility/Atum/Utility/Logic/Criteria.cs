...
namespace Atum.Utility.Logic
{
	...
	/// </summary>
	public sealed class Criteria : CriterionBase, IDisposable
	{
...
//			_colCriteria = new Hashtable();
        ...
        //public Criterion Add(string propName, Ops op, string propValue, bool IsLiteral, CritQuantifier quant)
        //{
        //    return AddCriterion(propName, op, propValue, IsLiteral, quant, CritQuantifier.NONE);
        //}

        //public Criterion AddAnd(string propName, Ops op, string propValue, bool IsLiteral, CritQuantifier quant)
        //{
        //    return AddCriterion(propName, op, propValue, IsLiteral, quant, CritQuantifier.AND);
        //}

        //public Criterion AddOr(string propName, Ops op, string propValue, bool IsLiteral, CritQuantifier quant)
        //{
        //    return AddCriterion(propName, op, propValue, IsLiteral, quant, CritQuantifier.OR);
        //}

        //private Criterion AddCriterion(string propName, Ops op, string propValue, bool IsLiteral, CritQuantifier quant, CritQuantifier newquant)
        //{
        //    Criterion criterion = Criterion.Instance(propName, op, propValue, IsLiteral, quant, newquant);
