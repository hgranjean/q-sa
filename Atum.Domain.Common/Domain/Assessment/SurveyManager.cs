...
//        private QuestionStrategies questionStrategies;
        ...
        private void setNextQuestions()
        {
            ...
            //i.e. we have achieved maximum confidence for the element under assessment
        ...
        /// <returns></returns>
        public void AcceptResponse(Question question, AnswerChoice answer)
        {
        ...
        public AnswerChoice PreviousAnswer { get; set; }
